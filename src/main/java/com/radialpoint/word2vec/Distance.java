...
public class Distance 
{
	...
	public static List<ScoredTerm> measure(Vectors vectors, int wordsToReturn, String[] tokens) throws OutOfVocabularyException 
	{
		...
		// org.ivdnt.openconvert.log.ConverterLog.defaultLog.println("1:" + startTime);
		...
		//org.ivdnt.openconvert.log.ConverterLog.defaultLog.println("2:" +  ( System.currentTimeMillis() - startTime));
		...
		//org.ivdnt.openconvert.log.ConverterLog.defaultLog.println("best:" + bestDistance[0]);
		//org.ivdnt.openconvert.log.ConverterLog.defaultLog.println("3:" +  ( System.currentTimeMillis() - startTime));
		List<ScoredTerm> result = new ArrayList<ScoredTerm>(wordsToReturn);
		for (int i = 0; i < wordsToReturn; i++)
			result.add(new ScoredTerm(bestWords[i], bestDistance[i]));
		return result;
