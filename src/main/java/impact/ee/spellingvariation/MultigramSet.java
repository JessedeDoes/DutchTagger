...
{ 
	...
	public Iterator<JointMultigram> sort()
	{
		...
		//org.ivdnt.openconvert.log.ConverterLog.defaultLog.println("multigrams in set/map " + s.size() +  " " + multigramMap.size());
 ...
 */
	...
	public void addToScore(int multigramId, double w)
	{
		...
		{
			org.ivdnt.openconvert.log.ConverterLog.defaultLog.println(multigramId + "/"  + scoreTable.size());
	...
	public void checkUp()
	{
		for (int i=0; i < nMultigrams; i++)
		{
			...
			{
				org.ivdnt.openconvert.log.ConverterLog.defaultLog.println("RAMP" + this.multigramVector.get(i));
				System.exit(1);
			}
		}
	}
