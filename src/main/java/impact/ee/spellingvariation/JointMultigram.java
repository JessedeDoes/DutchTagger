...
/**
	...
	public class JointMultigram implements java.io.Serializable
	{
		...
		public JointMultigram(MultigramSet set)
		{
			...
			set.nMultigrams++;
			org.ivdnt.openconvert.log.ConverterLog.defaultLog.println("Boe?? " + this.getClass() + " size now: " + set.nMultigrams);
		}
 ...
 */
		public void initData(int[] multigram, int endPosition)
		{
			...
			//org.ivdnt.openconvert.log.ConverterLog.defaultLog.println(lhs + "->" + rhs);
		}
