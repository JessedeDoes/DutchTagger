...
*/
     ...
     if ((!s.equals(t)) && s.length() > 0 && t.length() > 0)
     {
        ...
        //org.ivdnt.openconvert.log.ConverterLog.defaultLog.println("left: " + leftContext + " right: " + rightContext + " in (" + s + ", " + t + ")");
  ...
  public boolean isOK(JointMultigram m)
  {
    ...
    //org.ivdnt.openconvert.log.ConverterLog.defaultLog.println("x=" + x + ", y=" + y + ", m= " + m);
    return x || !y || z;
  }
