...
public class MapDBLexicon implements ILexicon
{
	...
	public void someStuff(String dbName)
	{
	    ...
	    {
	    	org.ivdnt.openconvert.log.ConverterLog.defaultLog.println(map.get(x));
	    }
	...
	private void addToIndexes(WordForm w)
	{
		...
		if (lemz.contains(w))
		{
			//org.ivdnt.openconvert.log.ConverterLog.defaultLog.println("I already had this: " + w);
		}
		lemz.add(w);
	...
	public static void main(String[] args)
	{
		...
		org.ivdnt.openconvert.log.ConverterLog.defaultLog.println("done reading lexicon!");
		...
		org.ivdnt.openconvert.log.ConverterLog.defaultLog.println("N=" + N + " d = " + d + " tpa = " + tpa);
