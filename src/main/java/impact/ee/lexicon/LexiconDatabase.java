...
public class LexiconDatabase extends impact.ee.util.Database implements Iterable<WordForm>, ILexicon 
{
	...
	public void init()
	{
		try 
		{
			...
			org.ivdnt.openconvert.log.ConverterLog.defaultLog.println("Connection: " + this.connection);
		} catch (Exception e)
		{
			e.printStackTrace();
			//System.exit(1);
	...
	public void createSimpleAnalyzedWordformTable()
	{
		...
		for (String q: parts)
		{
			org.ivdnt.openconvert.log.ConverterLog.defaultLog.println(q);
			this.runQuery(q);
		}
	}
	...
	{
		//org.ivdnt.openconvert.log.ConverterLog.defaultLog.println(createSimpleWordformTableSQL);
		org.ivdnt.openconvert.log.ConverterLog.defaultLog.println("load database...");
		...
		org.ivdnt.openconvert.log.ConverterLog.defaultLog.println("database loaded");
		int k=0;
		...
		out.flush();
		org.ivdnt.openconvert.log.ConverterLog.defaultLog.println("#wordforms; " + k);
