...
public class QuotationCorpus implements impact.ee.tagger.Corpus, Iterable<Context>, Iterator<Context> 
{
	...
	public QuotationCorpus(LexiconDatabase lexiconDatabase, inTraining t, inSample s)
	{
		...
		{
			org.ivdnt.openconvert.log.ConverterLog.defaultLog.println("NO SIMPLE ANALYZED WORDFORMS!");
			//System.exit(1);
	...
	public static void main(String[] args) throws Exception
	{
		...
		{
			org.ivdnt.openconvert.log.ConverterLog.defaultLog.println(N + " " +  c.getAttributeAt("word",-1)  + "_" + c.getAttributeAt("word", 0) +  "_" + 
					c.getAttributeAt("word",1) + " LEMMA:" + c.getAttributeAt("lemma" , 0) + " " + c.getAttributeAt("quote", 0));
			N++;
		}
		org.ivdnt.openconvert.log.ConverterLog.defaultLog.println("N= " + N);
		System.exit(0);
	}
}