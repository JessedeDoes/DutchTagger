...
class WordFormIterator implements Iterator<WordForm>
{
	...
	public WordFormIterator(LexiconDatabase lexiconDatabase)
	{
		...
		try
		{
			org.ivdnt.openconvert.log.ConverterLog.defaultLog.println(this.lexiconDatabase.connection);
		...
		} catch (Exception e)
		{
			...
			org.ivdnt.openconvert.log.ConverterLog.defaultLog.println("piep: exception...");
			e.printStackTrace();				
		}
	}
