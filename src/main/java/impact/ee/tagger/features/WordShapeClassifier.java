...
public class WordShapeClassifier 
{
  ...
  public static String wordShapeDan2(String s, boolean markKnownLC) {
    ...
    // org.ivdnt.openconvert.log.ConverterLog.defaultLog.println("wordShapeDan2: " + s + " became " + sb);
    return sb.toString();
  }
  ...
  public static void main(String[] args) {
    ...
    if (args.length == 0) {
      ...
      if (args[0].equals("-wordShape") && args.length >= 2) {
        ...
        org.ivdnt.openconvert.log.ConverterLog.defaultLog.println("Unknown flag: " + args[0]);
        i++;
      }
    }
