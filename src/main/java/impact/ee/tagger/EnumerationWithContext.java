...
public class EnumerationWithContext<T> implements Iterator<T>// T is the token-with-attributes type
{
	...
	{
		//org.ivdnt.openconvert.log.ConverterLog.defaultLog.println("element class:" + elementClass);
		//org.ivdnt.openconvert.log.ConverterLog.defaultLog.println("default:" + defaultT);
