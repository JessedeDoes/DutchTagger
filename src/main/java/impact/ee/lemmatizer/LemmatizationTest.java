			...
			while ((line = input.readLine()) != null)
			{
				...
				if (parts.length > 1)
				{
					for (String l: parts[1].split("\\|"))
					{
						...
						//org.ivdnt.openconvert.log.ConverterLog.defaultLog.println("<" + l + ">");
					}
				...
				{
					org.ivdnt.openconvert.log.ConverterLog.defaultLog.println("skipping " + line);
					continue;
				}
				...
				if (matches==null || matches.size()==0)
				{
					...
					org.ivdnt.openconvert.log.ConverterLog.defaultLog.println("no match for item " + item.n);
