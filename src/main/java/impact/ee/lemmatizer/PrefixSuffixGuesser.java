...
public class PrefixSuffixGuesser implements ParadigmExpander, FoundFormHandler, Classifier
{
	...
	class Knutselaar implements FoundFormHandler
	{
				...
				double p, int rank)
		{
			...
			//	org.ivdnt.openconvert.log.ConverterLog.defaultLog.println(r + " for " + lemma + ":" + tag);
		...
		public ScoredRule knutsel() // what about the scores...
		{
			...
			try
			{
				...
				//org.ivdnt.openconvert.log.ConverterLog.defaultLog.println("Concocted: " + r);
	...
	{
		//org.ivdnt.openconvert.log.ConverterLog.defaultLog.println("start expanding: " + w);
		...
		{
			org.ivdnt.openconvert.log.ConverterLog.defaultLog.println("Could not expand: " + w);
		}
	}
	...
	public void foundForm(String lemma, String tag, String lemmaPoS, Rule r, double p, int rank)
	{
		...
		{
			org.ivdnt.openconvert.log.ConverterLog.defaultLog.println("Unable to apply " + r.pattern + " to " + lemma);
		}
	}	
