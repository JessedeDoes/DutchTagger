		...
		try
		{
			...
			while (( line= b.readLine())!=null)
			{
				...
				if (examples != null)
				{
					...
					{	
						//org.ivdnt.openconvert.log.ConverterLog.defaultLog.println(e);
						rl.addWordform(e);
					}
				...
				{
					org.ivdnt.openconvert.log.ConverterLog.defaultLog.println("Nee, niks gevonden voor voorbeeldlemma " + fields[0]);
				}
			}
		} catch (Exception e)
		{
			org.ivdnt.openconvert.log.ConverterLog.defaultLog.println("Error expanding " + currentWordForm);
			e.printStackTrace();
		}
	}
