...
public class IRLexiconEvaluation 
{
	...
	public void matchTypeStatistics()
	{
		...
		{
			org.ivdnt.openconvert.log.ConverterLog.defaultLog.println(m + ": " + typeHash.get(m));
		}
	}
	...
	private void prepareForPrecision() 
	{
		...
		org.ivdnt.openconvert.log.ConverterLog.defaultLog.println("Total distinct TRUE lemmata " + lemmaFrequency.keySet().size());
		org.ivdnt.openconvert.log.ConverterLog.defaultLog.println("Total distinct assigned lemmata " + lemma2item.keySet().size());
	...
	public double averagePrecision(String lemmaQuery) 
	{
		...
		org.ivdnt.openconvert.log.ConverterLog.defaultLog.println("precision for " + lemmaQuery + ": " + d);
		return d;
	}
	...
	public void calculate()
	{
		...
		{
			org.ivdnt.openconvert.log.ConverterLog.defaultLog.println("RAMP.... KLOPT NIET.....");
		}
	}
