...
public class Tag extends HashMap<String, Set<String>> 
{
	...
	public void put(String name, String value)
	{
		...
		v.add(value);
		///org.ivdnt.openconvert.log.ConverterLog.defaultLog.println("just added to set for " + name + "  " + ",  now "  + get(name) +  " value = "  + value);
	}
	...
	public static Tag parseParoleStyleTag(String tag)
	{
		...
		//org.ivdnt.openconvert.log.ConverterLog.defaultLog.println(t);
		return t;
	}
