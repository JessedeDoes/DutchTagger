...
public class Gazetteer 
{
	...
	{
		org.ivdnt.openconvert.log.ConverterLog.defaultLog.println("reading gazetteer: " + fileName);
		try
		{
		...
		org.ivdnt.openconvert.log.ConverterLog.defaultLog.println("finished reading gazetteer: " + fileName);
	}
	...
	public void findMatches(String[] words)
	{
		...
		for (int i=0; i < words.length; i++)
		{
			...
			// org.ivdnt.openconvert.log.ConverterLog.defaultLog.println(i + " " + next.size());
			for (ScanState snext: next.values())
			{
				if (snext.isFinal())
				{
					...
					org.ivdnt.openconvert.log.ConverterLog.defaultLog.println("Complete Match " + V1);
				} 
			}
			state = next;
		}
	...
	public static void main(String[] args)
	{
		...
		org.ivdnt.openconvert.log.ConverterLog.defaultLog.println(g.nEntries());
