...
public class TEITokenizer extends DefaultHandler
{
	...
	public  void startElement(String uri, String localName, String qName, Attributes attributes) 
	{
		...
		} else
		{
			...
			{
				//org.ivdnt.openconvert.log.ConverterLog.defaultLog.println("milestone: " + qName);
				printStartTag(e);
	...
	public String getTempDir()
	{
		 String property = "java.io.tmpdir";
	      ...
	      org.ivdnt.openconvert.log.ConverterLog.defaultLog.println("OS current temporary directory is " + tempDir);
	      return tempDir;
	}
	...
	public Document getTokenizedDocument(String fileName, boolean splitPunctuation)
	{
		...
		try
		{
			...
			org.ivdnt.openconvert.log.ConverterLog.defaultLog.println("pretokenization time: "  + step1Time);
			Document d = null;
			...
			{
				org.ivdnt.openconvert.log.ConverterLog.defaultLog.println("error in pretokenized file " + pretokenizedFile.getCanonicalPath() );
				e.printStackTrace();
				//System.exit(1);
			...
			org.ivdnt.openconvert.log.ConverterLog.defaultLog.println("tokenization time: "  + elapsed);
			return d;
		} catch (Exception e)
		{
			e.printStackTrace();
