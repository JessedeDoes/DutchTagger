...
public class Proxy 
{
	...
	public static void setProxy()
	{
		try
		{
			...
			{
				org.ivdnt.openconvert.log.ConverterLog.defaultLog.println("use inl proxy only inside inl.loc: " + canonicalhost);
				return;
			} else
			{
				org.ivdnt.openconvert.log.ConverterLog.defaultLog.println("use inl proxy, we are inside inl.loc: " + canonicalhost);
			}
		} catch (Exception e)
		{
			e.printStackTrace();
