...
public class TagSoupParser implements org.ivdnt.openconvert.filehandling.SimpleInputOutputProcess
{
	static
	{
	...
	public static Document parse2DOM(String sURL)
	{
		...
		{ 
			...
			//= f.toURI().toURL();
			//org.ivdnt.openconvert.log.ConverterLog.defaultLog.println(url);
			...
			doc = sax2dom.getDOM();
			//org.ivdnt.openconvert.log.ConverterLog.defaultLog.println(doc);
		} catch (Exception e) 
		{
