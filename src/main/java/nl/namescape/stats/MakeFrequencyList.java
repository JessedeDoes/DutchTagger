...
public class MakeFrequencyList implements org.ivdnt.openconvert.filehandling.DoSomethingWithFile
{
	...
	public void handleFile(String fileName) 
	{
		try
		{
			...
			{
				org.ivdnt.openconvert.log.ConverterLog.defaultLog.println("Unwrapped words in " + fileName);
			}
		...
		{
			org.ivdnt.openconvert.log.ConverterLog.defaultLog.println("Parse error in " + fileName);
			e.printStackTrace();
		}
	}
