...
public class ImpactTaggerLemmatizerClient extends ImpactTaggingClient 
{
	...
	public boolean CheckIllegalCharacters(String s)
	{
		for (int i=0; i < s.length(); i++)
		{
			...
			{
				org.ivdnt.openconvert.log.ConverterLog.defaultLog.printf("dangerous character in %s\n", s);
				return false;
			}
		}
		return true;
	...
	public static void main(String[] args)
	{
        ...
        if (options.getOption("nThreads") != null)
        {
        	...
        	{
        		org.ivdnt.openconvert.log.ConverterLog.defaultLog.println("Error in threads option");
        	}
        }
		Tagger taggerLemmatizer = 
		...
		org.ivdnt.openconvert.log.ConverterLog.defaultLog.println("Start tagging from " + args[2] + " to " + args[3]);
