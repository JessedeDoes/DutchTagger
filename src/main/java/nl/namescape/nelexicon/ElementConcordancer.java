...
public class ElementConcordancer 
{
	...
	public String getConcordance(Element n) 
	{
		...
		while (true)
		{
			...
			org.ivdnt.openconvert.log.ConverterLog.defaultLog.println("SIZE "  + words.length);
		...
		// org.ivdnt.openconvert.log.ConverterLog.defaultLog.println(XML.documentToString(tokenizedElement));
		...
		if (nameInContextx.size() == 0)
		{
			...
			org.ivdnt.openconvert.log.ConverterLog.defaultLog.println(n.getAttribute("xml:id") +  " NOT FOUND IN " + XML.documentToString(tokenizedElement));
			return "";
		}
		...
		org.ivdnt.openconvert.log.ConverterLog.defaultLog.println("CONC: " + concordance);
		return concordance;
	}
