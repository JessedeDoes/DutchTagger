...
public class BIOFile implements NETaggedDocument
{
	...
	public void read(String fileName)
	{
		...
		while ((line  = f.getLine()) != null)
		{
			...
			{
				//org.ivdnt.openconvert.log.ConverterLog.defaultLog.println(line[0]);
				...
				if (tagParts[0].equals("I"))
				{
					if (currentEntity == null)
					{
						org.ivdnt.openconvert.log.ConverterLog.defaultLog.println("Unexpected internal entity at: " + l + " : " + line[0]);
					}
					else
					{
						...
						if (currentEntity.type.equals(type))
							...
							org.ivdnt.openconvert.log.ConverterLog.defaultLog.println("Inconsistent entity types for I " +l + " : "  + line[0]);
					}
				}
			} catch (Exception e)
			{
