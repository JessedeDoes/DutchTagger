...
public class ConstructionExamples
{
	public static void main(String[] args)
	{
		...
		org.ivdnt.openconvert.log.ConverterLog.defaultLog.println("search exampes for: <" + args[1] + ">");
		Set<String> examples = atb.allExamples.get(args[1]);
		if (examples == null)
		{
			org.ivdnt.openconvert.log.ConverterLog.defaultLog.println("none found...");
			System.exit(0);
		}
