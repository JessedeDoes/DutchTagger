...
public class AlpinoTreebank implements DoSomethingWithFile
{
		   ...
		   if (nTokens > max_tokens)
			...
			try
			{
				...
				if (lastWord.equals("." ) && l > 8)
				{
					...
					nTokens += l;
					//org.ivdnt.openconvert.log.ConverterLog.defaultLog.println(l + "  " + nTokens);
				}
			} catch (Exception e)
			{
				e.printStackTrace();
	...
	public static void main(String[] args)
	{
		...
		org.ivdnt.openconvert.log.ConverterLog.defaultLog.println("K=" + atb.K());
		org.ivdnt.openconvert.log.ConverterLog.defaultLog.println("Number of sentences: " + atb.sentences.size());
		org.ivdnt.openconvert.log.ConverterLog.defaultLog.println("Average sentence length: " + atb.nTokens / (double) atb.sentences.size());
		org.ivdnt.openconvert.log.ConverterLog.defaultLog.println("Number of productions:"  + atb.totalProductions);
